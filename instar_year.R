...
parameters <- list(mu0                 = 10,                        # First instar mean size.
                   ...
                   log_selectivity_slope = -2.4,                    # Logit-scale trawl selectivity slope.
                   logit_p_skp = c(rep(-3, 4), rep(0, n_instar-4)), # Logit-scale skip-moulting probabilities (n_instar).
                   logit_p_mat = c(rep(-3, 4), rep(0, n_instar-4)), # Logit-scale moult-to-maturity probabilities (n_instar).
